...
const string TOK_ERROR = "Error";
const string TOK_ENTERO = "Entero";
const string TOK_REAL = "Real";
const string TOK_CONSTANTE = "Constante";
const string TOK_VARIABLE = "Variable";
const string TOK_CUANTIFICADOR = "Cuantificador";
const string TOK_EXPONENCIAL = "Exponencial";
const string TOK_PRODUCTO = "Producto";
const string TOK_ADITIVO = "Aditivo";
const string TOK_RELACIONAL = "Relacional";
const string TOK_LOGICO = "Logico";
const string TOK_PARENTESIS = "Parentesis";
const string TOK_SEPARADOR = "Separador";
const string TOK_NEGACION = "Negacion";
const int TAM_G = 21;
int G[TAM_G][TAM_G]{
...
int main(){
	...
	Lex<TAM_G> lex(G,codigo,tipoToken,clase);
	while(not lex.fin()){
		cout<<lex.siguiente()<<endl;
	}
	return 0;
}